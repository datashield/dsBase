...
client-side and used for the estimation of the combined skewness of a
...
a list including the sum of cubed differences between the values of x
...
cubed differences between the values of x and the global mean of x
