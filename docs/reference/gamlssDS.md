...
- family:
  ...
  Functions such as BI() (binomial) produce a family object. Also can be
  given without the parentheses i.e. BI. Family functions can take
...
- newobj:
  ...
  is stored on the data servers. Default `gamlss_residuals`.
