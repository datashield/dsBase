#' @title rBinomDS.o serverside assign function
#' @description primary serverside assign function called by ds.rBinom.o
...
#' ds.rBinom.o. This serverside function is effectively the same as
...
#' as specified by the argument <samp.size> in the function ds.rBinom.o
#' @param size a scalar that must be a positive integer. Value set directly
#' by <size> argument of ds.rBinom.o - for details see help for ds.rBinom.o.
...
#' by <prob> argument of ds.rBinom.o - for details see help for ds.rBinom.o
#' May be a scalar or a vector allowing the size to vary from
#' observation to observation.
