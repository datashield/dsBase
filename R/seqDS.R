...
#' to the argument <BY.value.char> in the function {ds.seq}
...
#' ds.seq (or default name newObj) which is written to the serverside.
...
#' @export
seqDS <- function(FROM.value.char,BY.value.char,LENGTH.OUT.value.char,ALONG.WITH.name)
{
