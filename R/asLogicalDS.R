...
if(is.character(x.name)){
  ...
  studysideMessage<-"ERROR: for ds.asLogical.o function, x.name must specify an input object of class numeric, integer or matrix"
  return(list(studysideMessage=studysideMessage))  
  }
