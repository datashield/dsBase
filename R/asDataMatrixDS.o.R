#' @title asDataMatrixDS.o a serverside assign function called by ds.asDataMatrix.o
#' @description Coerces an R object into a matrix maintaining original
#' class for all columns in data.frames. 
#' @details This assign function is based on the native R function {data.matrix}
...
#' details see help on the clientside function {ds.asDataMatrix.o} 
#' @author Paul Burton for DataSHIELD Development Team
#' @export
asDataMatrixDS.o <- function (x.name){
