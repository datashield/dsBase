#' 
#' @title lmeSLMADS2.o
#' @description This is the serverside function called by ds.lmerSLMA.o.
#' @details It is an
#' aggregation function that fits the linear mixed effect model (lme) specified
#' in the call to ds.lmerSLMA.o. The model is first converted into a glm format
#' and disclosure checked using the standard glm process. It is then fitted to convergence
#' on each study separately using lmerSLMADS2.o to return parameter estimates
...
#' @return model components:- lmerDSDLMA2.o returns key components of model fit
