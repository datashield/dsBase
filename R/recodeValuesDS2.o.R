###############################################################################|###################| 80 and 100#'
#' @title recodeValuesDS2.o an assign function called by ds.recodeValues.o
#' @description Second serverside function called by ds.recodeValues.o
...
#' and so can be accepted by recodeValuesDS2.o
...
#' and so can be used in the call to recodeValuesDS2.o
...
#' This argument is  generated and passed directly to recodeValuesDS2.o
#' by ds.recodeValues.o - its value determines how recodeValuesDS2.o
...
#' and passed directly to recodeValuesDS2.o by ds.recodeValues.o. For details
#' see the equivalent parameter in the help header for ds.recodeValues.o
#' @param v2r.numeric logical. This argument is generated
#' and passed directly to recodeValuesDS2.o by ds.recodeValues.o. If TRUE
#' it informs recodeValuesDS2.o that the nature of 
...
#' initially specified in calling ds.recodeValues.o. The output object (the required
#' recoded variable called <newobj> is written to the serverside. In addition,
#' two validity messages are returned via ds.recodeValues.o
#' indicating whether <newobj> has been created in each data source and if so whether
#' it is in a valid form. If its form is not valid in at least one study - e.g. because
#' a disclosure trap was tripped and creation of the full output object was blocked -
#' recodeValuesDS2.o (via ds.recodeValues.o()) also returns any studysideMessages
